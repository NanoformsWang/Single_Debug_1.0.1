...
public class FrescoHelper {
    ...
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "cache";//小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = "cache";//默认图所放路径的文件夹名
    ...
    public static FrescoHelper getInstance() {
        return helper == null ? new FrescoHelper() : helper;
    }
